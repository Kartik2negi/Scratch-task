...
;// CONCATENATED MODULE: ./src/components/motion/MoveX.js
...
function MoveX() {
  var _useState = (0,react.useState)(0),
    ...
    stepsX = _useState2[0],
    setStepsX = _useState2[1];
  var handleClick = function handleClick() {
    var ele = document.getElementById('active-cat');
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    onChange: function onChange(e) {
      return setStepsX(parseInt(e.target.value));
    }
  }), "steps : X");
}
/* harmony default export */ var motion_MoveX = (MoveX);
;// CONCATENATED MODULE: ./src/components/motion/MoveY.js
function MoveY_slicedToArray(arr, i) { return MoveY_arrayWithHoles(arr) || MoveY_iterableToArrayLimit(arr, i) || MoveY_unsupportedIterableToArray(arr, i) || MoveY_nonIterableRest(); }
function MoveY_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function MoveY_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return MoveY_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return MoveY_arrayLikeToArray(o, minLen); }
function MoveY_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function MoveY_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function MoveY_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

function MoveY() {
  var _useState = (0,react.useState)(0),
    _useState2 = MoveY_slicedToArray(_useState, 2),
    stepsY = _useState2[0],
    setStepsY = _useState2[1];
  var handleClick = function handleClick() {
    var ele = document.getElementById('active-cat');
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    value: stepsY,
    onChange: function onChange(e) {
      return setStepsY(parseInt(e.target.value));
    }
  }), "steps : Y");
}
/* harmony default export */ var motion_MoveY = (MoveY);
;// CONCATENATED MODULE: ./src/components/motion/TurnClockDirection.js
function TurnClockDirection_slicedToArray(arr, i) { return TurnClockDirection_arrayWithHoles(arr) || TurnClockDirection_iterableToArrayLimit(arr, i) || TurnClockDirection_unsupportedIterableToArray(arr, i) || TurnClockDirection_nonIterableRest(); }
function TurnClockDirection_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function TurnClockDirection_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return TurnClockDirection_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return TurnClockDirection_arrayLikeToArray(o, minLen); }
function TurnClockDirection_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function TurnClockDirection_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function TurnClockDirection_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }


function TurnClockDirection() {
  var _useState = (0,react.useState)(0),
    _useState2 = TurnClockDirection_slicedToArray(_useState, 2),
    rotateClockWise = _useState2[0],
    setRotateClockWise = _useState2[1];
  var _useState3 = (0,react.useState)({
      angle: 0
    }),
    _useState4 = TurnClockDirection_slicedToArray(_useState3, 2),
    checkAngle = _useState4[0],
    setCheckAngle = _useState4[1];
  var handleTurnClockDirection = function handleTurnClockDirection() {
    setCheckAngle({
      angle: checkAngle.angle + rotateClockWise
    });
    var ele = document.getElementById('active-cat');
    ele.style.position = "relative";
    ele.style.transform = "rotate(".concat(rotateClockWise + checkAngle.angle, "deg)");
  };
  return /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer",
    onClick: function onClick() {
      return handleTurnClockDirection();
    }
...
/* harmony default export */ var motion_TurnClockDirection = (TurnClockDirection);
;// CONCATENATED MODULE: ./src/components/motion/TurnAntiClockDirection.js
function TurnAntiClockDirection_slicedToArray(arr, i) { return TurnAntiClockDirection_arrayWithHoles(arr) || TurnAntiClockDirection_iterableToArrayLimit(arr, i) || TurnAntiClockDirection_unsupportedIterableToArray(arr, i) || TurnAntiClockDirection_nonIterableRest(); }
function TurnAntiClockDirection_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function TurnAntiClockDirection_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return TurnAntiClockDirection_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return TurnAntiClockDirection_arrayLikeToArray(o, minLen); }
function TurnAntiClockDirection_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function TurnAntiClockDirection_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function TurnAntiClockDirection_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }


function TurnAntiClockDirection() {
  var _useState = (0,react.useState)(0),
    _useState2 = TurnAntiClockDirection_slicedToArray(_useState, 2),
    rotateAntiClockWise = _useState2[0],
    setRotateAntiClockWise = _useState2[1];
  var _useState3 = (0,react.useState)({
      angle: 0
    }),
    _useState4 = TurnAntiClockDirection_slicedToArray(_useState3, 2),
    checkAngle = _useState4[0],
    setCheckAngle = _useState4[1];
  var handleTurnAntiClockDirection = function handleTurnAntiClockDirection() {
    setCheckAngle({
      angle: checkAngle.angle - rotateAntiClockWise
    });
    var ele = document.getElementById('active-cat');
    ele.style.position = "relative";
    ele.style.transform = "rotate(".concat(-rotateAntiClockWise + checkAngle.angle, "deg)");
  };
  return /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer",
    onClick: function onClick() {
      return handleTurnAntiClockDirection();
    }
  }, "Turn ", /*#__PURE__*/react.createElement(Icon, {
    name: "undo",
    size: 15,
...
/* harmony default export */ var motion_TurnAntiClockDirection = (TurnAntiClockDirection);
...
;// CONCATENATED MODULE: ./src/components/Motion.js
function Motion_extends() { Motion_extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return Motion_extends.apply(this, arguments); }
...
function Motion() {
  var component = [{
    id: 0,
    child: /*#__PURE__*/react.createElement(motion_MoveX, null)
  }, {
    id: 1,
    child: /*#__PURE__*/react.createElement(motion_MoveY, null)
  }, {
    id: 2,
    child: /*#__PURE__*/react.createElement(motion_TurnAntiClockDirection, null)
  }, {
    id: 3,
    child: /*#__PURE__*/react.createElement(motion_TurnClockDirection, null)
  }];
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(DragDropContext, {
    ...
    return /*#__PURE__*/react.createElement("div", Motion_extends({
      ref: provided.innerRef
    }, provided.droppableProps, {
      className: "droppable-area"
    }), component === null || component === void 0 ? void 0 : component.map(function (item, index) {
      return /*#__PURE__*/react.createElement(PublicDraggable, {
        ...
        return /*#__PURE__*/react.createElement("div", Motion_extends({
          ref: provided.innerRef
        }, provided.draggableProps, provided.dragHandleProps), item.child);
      });
    }));
  })));
}
/* harmony default export */ var components_Motion = (Motion);
;// CONCATENATED MODULE: ./src/components/looks/MessageWithTimeout.js
function MessageWithTimeout_typeof(obj) { "@babel/helpers - typeof"; return MessageWithTimeout_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, MessageWithTimeout_typeof(obj); }
function MessageWithTimeout_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? MessageWithTimeout_ownKeys(Object(source), !0).forEach(function (key) { MessageWithTimeout_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : MessageWithTimeout_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function MessageWithTimeout_defineProperty(obj, key, value) { key = MessageWithTimeout_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function MessageWithTimeout_toPropertyKey(arg) { var key = MessageWithTimeout_toPrimitive(arg, "string"); return MessageWithTimeout_typeof(key) === "symbol" ? key : String(key); }
function MessageWithTimeout_toPrimitive(input, hint) { if (MessageWithTimeout_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (MessageWithTimeout_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function MessageWithTimeout_slicedToArray(arr, i) { return MessageWithTimeout_arrayWithHoles(arr) || MessageWithTimeout_iterableToArrayLimit(arr, i) || MessageWithTimeout_unsupportedIterableToArray(arr, i) || MessageWithTimeout_nonIterableRest(); }
function MessageWithTimeout_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function MessageWithTimeout_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return MessageWithTimeout_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return MessageWithTimeout_arrayLikeToArray(o, minLen); }
function MessageWithTimeout_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function MessageWithTimeout_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function MessageWithTimeout_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function MessageWithTimeout() {
  var _useState = (0,react.useState)({
    ...
    _useState2 = MessageWithTimeout_slicedToArray(_useState, 2),
    state = _useState2[0],
    setState = _useState2[1];
  var handleMessage = function handleMessage() {
    var ele = document.getElementById("message-box-id");
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    onChange: function onChange(e) {
      e.target.value.length > 0 && setState(_objectSpread(_objectSpread({}, state), {}, {
    ...
    onChange: function onChange(e) {
      parseInt(e.target.value) > 0 && setState(_objectSpread(_objectSpread({}, state), {}, {
        timer_for_msg: parseInt(e.target.value)
      }));
    }
  }), "seconds");
}
/* harmony default export */ var looks_MessageWithTimeout = (MessageWithTimeout);
;// CONCATENATED MODULE: ./src/components/looks/SayMessage.js
function SayMessage_typeof(obj) { "@babel/helpers - typeof"; return SayMessage_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, SayMessage_typeof(obj); }
function SayMessage_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function SayMessage_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? SayMessage_ownKeys(Object(source), !0).forEach(function (key) { SayMessage_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : SayMessage_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function SayMessage_defineProperty(obj, key, value) { key = SayMessage_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function SayMessage_toPropertyKey(arg) { var key = SayMessage_toPrimitive(arg, "string"); return SayMessage_typeof(key) === "symbol" ? key : String(key); }
function SayMessage_toPrimitive(input, hint) { if (SayMessage_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (SayMessage_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function SayMessage_slicedToArray(arr, i) { return SayMessage_arrayWithHoles(arr) || SayMessage_iterableToArrayLimit(arr, i) || SayMessage_unsupportedIterableToArray(arr, i) || SayMessage_nonIterableRest(); }
function SayMessage_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function SayMessage_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return SayMessage_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return SayMessage_arrayLikeToArray(o, minLen); }
function SayMessage_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function SayMessage_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function SayMessage_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function SayMessage() {
  var _useState = (0,react.useState)({
    ...
    _useState2 = SayMessage_slicedToArray(_useState, 2),
    state = _useState2[0],
    setState = _useState2[1];
  var handleMessage = function handleMessage() {
    var ele = document.getElementById("message-box-id");
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    value: state.timer_message,
    onChange: function onChange(e) {
      e.target.value.length > 0 && setState(SayMessage_objectSpread(SayMessage_objectSpread({}, state), {}, {
        timer_message: e.target.value
      }));
    }
  }));
}
/* harmony default export */ var looks_SayMessage = (SayMessage);
;// CONCATENATED MODULE: ./src/components/looks/ThinkMessage.js
function ThinkMessage_typeof(obj) { "@babel/helpers - typeof"; return ThinkMessage_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, ThinkMessage_typeof(obj); }
function ThinkMessage_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function ThinkMessage_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ThinkMessage_ownKeys(Object(source), !0).forEach(function (key) { ThinkMessage_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ThinkMessage_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function ThinkMessage_defineProperty(obj, key, value) { key = ThinkMessage_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function ThinkMessage_toPropertyKey(arg) { var key = ThinkMessage_toPrimitive(arg, "string"); return ThinkMessage_typeof(key) === "symbol" ? key : String(key); }
function ThinkMessage_toPrimitive(input, hint) { if (ThinkMessage_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (ThinkMessage_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function ThinkMessage_slicedToArray(arr, i) { return ThinkMessage_arrayWithHoles(arr) || ThinkMessage_iterableToArrayLimit(arr, i) || ThinkMessage_unsupportedIterableToArray(arr, i) || ThinkMessage_nonIterableRest(); }
function ThinkMessage_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function ThinkMessage_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return ThinkMessage_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ThinkMessage_arrayLikeToArray(o, minLen); }
function ThinkMessage_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function ThinkMessage_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function ThinkMessage_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function ThinkMessage() {
  var _useState = (0,react.useState)({
    ...
    _useState2 = ThinkMessage_slicedToArray(_useState, 2),
    state = _useState2[0],
    setState = _useState2[1];
  var handleThinkMessage = function handleThinkMessage() {
    var ele = document.getElementById("message-box-id-think");
    var ele1 = document.getElementById("message-box-id-think-1");
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer",
    onClick: function onClick() {
      return handleThinkMessage();
    }
  }, "Think", /*#__PURE__*/react.createElement("input", {
    type: "text",
    className: "text-black text-center w-12 mx-2 rounded-full",
    value: state.message,
    onChange: function onChange(e) {
      e.target.value.length > 0 && setState(ThinkMessage_objectSpread(ThinkMessage_objectSpread({}, state), {}, {
        message: e.target.value
      }));
    }
  }));
}
/* harmony default export */ var looks_ThinkMessage = (ThinkMessage);
;// CONCATENATED MODULE: ./src/components/looks/ThinkMessageWithTimeout.js
function ThinkMessageWithTimeout_typeof(obj) { "@babel/helpers - typeof"; return ThinkMessageWithTimeout_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, ThinkMessageWithTimeout_typeof(obj); }
function ThinkMessageWithTimeout_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function ThinkMessageWithTimeout_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ThinkMessageWithTimeout_ownKeys(Object(source), !0).forEach(function (key) { ThinkMessageWithTimeout_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ThinkMessageWithTimeout_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function ThinkMessageWithTimeout_defineProperty(obj, key, value) { key = ThinkMessageWithTimeout_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function ThinkMessageWithTimeout_toPropertyKey(arg) { var key = ThinkMessageWithTimeout_toPrimitive(arg, "string"); return ThinkMessageWithTimeout_typeof(key) === "symbol" ? key : String(key); }
function ThinkMessageWithTimeout_toPrimitive(input, hint) { if (ThinkMessageWithTimeout_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (ThinkMessageWithTimeout_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function ThinkMessageWithTimeout_slicedToArray(arr, i) { return ThinkMessageWithTimeout_arrayWithHoles(arr) || ThinkMessageWithTimeout_iterableToArrayLimit(arr, i) || ThinkMessageWithTimeout_unsupportedIterableToArray(arr, i) || ThinkMessageWithTimeout_nonIterableRest(); }
function ThinkMessageWithTimeout_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function ThinkMessageWithTimeout_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return ThinkMessageWithTimeout_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ThinkMessageWithTimeout_arrayLikeToArray(o, minLen); }
function ThinkMessageWithTimeout_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function ThinkMessageWithTimeout_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function ThinkMessageWithTimeout_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function ThinkMessageWithTimeout() {
  var _useState = (0,react.useState)({
    ...
    _useState2 = ThinkMessageWithTimeout_slicedToArray(_useState, 2),
    state = _useState2[0],
    setState = _useState2[1];
  var handleThinkMessageTimeout = function handleThinkMessageTimeout() {
    var ele = document.getElementById("message-box-id-think");
    var ele1 = document.getElementById("message-box-id-think-1");
    ele1.innerHTML = state.message;
    ele.style.display = "block";
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer",
    onClick: function onClick() {
      return handleThinkMessageTimeout();
    }
  }, "Think", /*#__PURE__*/react.createElement("input", {
    type: "text",
    className: "text-black text-center w-12 mx-2 rounded-full",
    value: state.message,
    onChange: function onChange(e) {
      e.target.value.length > 0 && setState(ThinkMessageWithTimeout_objectSpread(ThinkMessageWithTimeout_objectSpread({}, state), {}, {
        message: e.target.value
      }));
    }
  }), "for", /*#__PURE__*/react.createElement("input", {
    ...
    value: state.timer,
    onChange: function onChange(e) {
      parseInt(e.target.value) > 0 && setState(ThinkMessageWithTimeout_objectSpread(ThinkMessageWithTimeout_objectSpread({}, state), {}, {
        timer: parseInt(e.target.value)
      }));
    }
  }), "seconds");
}
/* harmony default export */ var looks_ThinkMessageWithTimeout = (ThinkMessageWithTimeout);
;// CONCATENATED MODULE: ./src/components/looks/index.js
...
function Looks() {
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(looks_SayMessage, null), /*#__PURE__*/react.createElement(looks_MessageWithTimeout, null), /*#__PURE__*/react.createElement(looks_ThinkMessage, null), /*#__PURE__*/react.createElement(looks_ThinkMessageWithTimeout, null));
}
/* harmony default export */ var looks = (Looks);
...
function Sidebar() {
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "font-bold"
  }, " ", "Motion", " "), /*#__PURE__*/react.createElement(components_Motion, null), /*#__PURE__*/react.createElement("div", {
    className: "font-bold"
  }, " ", "Looks", " "), /*#__PURE__*/react.createElement(looks, null));
}
...
function PreviewArea() {
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "hidden",
    id: "message-box-id-think"
  }, /*#__PURE__*/react.createElement("div", {
    className: "border-2 p-1 ml-2 nb-2 w-auto whitespace-nowrap",
    id: "message-box-id-think-1"
  }), /*#__PURE__*/react.createElement("div", {
    className: "border-2 rounded-full w-4 h-4 mt-1 ml-20 mb-1"
  }), /*#__PURE__*/react.createElement("div", {
    className: "border-2 rounded-full w-2 h-2 mt-1 ml-16 mb-1"
...
/*#__PURE__*/
// <React.StrictMode>
react.createElement(App_App, null), document.getElementById("root"));
}();
/******/ })()
;